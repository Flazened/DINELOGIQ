...
<head>
    ...
    <body>
                ...
                <div class="flex justify-center">
                    <div class="grid grid-cols-3 gap-12 -ml-20">
                        ...
                        <section class="flex justify-between items-center px-4 rounded-[38px] ml-25 mr-5 bg-[#004643] border-5 border-[#667080] h-20 w-80">
                            <img src="{{ asset('img/Food/' . $cat['icon']) }}" class="h-10 w-auto">
                            <p class="text-white font-medium text-[25px] mr-10">{{ $cat['name'] }}</p>
                        </section>
                        @endforeach
                    </div>
                </div>
        ...
        <div class="bg-[#201B1B] h-auto py-20 px-5">
            ...
            <div class="flex justify-between px-10">
                ...
                <div class="bg-[#004643] h-15 w-30 rounded-[40px] ">
                    <div class="flex mt-3 ml-5">
                        ...
                        <p class="text-white -mt-2 text-[35px] font-bold px-4">{{ $cartCount }}</p>
                    </div>
                </div>
            </div>
