<footer class="relative">
    ...
    <div class="relative z-10 flex justify-center -ml-140">
        ...
        <div class="relative z-10 flex -ml-48 mt-60">
            <img src="{{ asset('img/Logo/Tiktok.png') }}" 
            class="w-8 h-8 ml-2">
            <img src="{{ asset('img/Logo/Instagram.png') }}" 
            class="w-8 h-8 ml-2">
            <img src="{{ asset('img/Logo/Twitter.png') }}" 
            class="w-8 h-8 ml-2">
            <img src="{{ asset('img/Logo/Facebook.png') }}" 
            class="w-8 h-8 ml-2">
             ...
             <div class="relative z-10 flex mt-10">
                <ul>
                    ...
                    <li class="text-white flex gap-2">
                        <img src="{{ asset('img/Logo/Whatsapp.png') }}">
                        082155487766</li>
                    <li class="text-white flex gap-2">
                        <img src="{{ asset('img/Logo/Gmail.png') }}">
                        dinelogiqcon@outlook.com</li>
                </ul>
             </div>
        </div>     
    </div>
